...
@section('content')
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.artworks.index') }}" class="text-sm text-zinc-300 hover:text-white">Back</a>
    </div>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input id="price" name="price" type="number" step="0.01" min="0"
                            ...
                            class="rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm outline-none ring-emerald-500 focus:ring-2" />
                    </div>
                </div>
