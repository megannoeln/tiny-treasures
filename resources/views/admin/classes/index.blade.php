...
@section('content')
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="font-serif text-[1.4rem] font-semibold tracking-wide">Classes</h1>
            <p class="mt-1 text-sm text-zinc-400">Classes show on the site and calendar.</p>
        </div>
        <a href="{{ route('admin.classes.create') }}" class="rounded-md bg-[#7a6230] px-4 py-2 text-sm font-semibold text-[#f5ecd3] hover:bg-[#8c733b]">New</a>
    </div>
